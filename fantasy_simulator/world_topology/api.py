...
from .route_graph import routes_for_site
from . import PROPAGATION_TOPOLOGY_TRAVEL
from .queries import (
    connected_site_ids,
...
from .runtime import apply_topology_state, route_index_by_site, site_index_by_location
from .state import (
    WorldTopologyState,
...
if TYPE_CHECKING:
    ...
    from .route_graph import RouteCollection
...
class WorldTopologyMixin:
    ...
    def _apply_topology_state(self, topology_state: WorldTopologyState) -> None:
        ...
        from ..world_core.protocols import TopologyRuntimeWorld
