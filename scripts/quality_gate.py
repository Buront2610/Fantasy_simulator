...
TYPECHECK_TARGETS = [
    ...
    "fantasy_simulator/event_rendering.py",
    "fantasy_simulator/events_combat.py",
    "fantasy_simulator/events_relationships.py",
    "fantasy_simulator/ids.py",
    "fantasy_simulator/location_observation.py",
    "fantasy_simulator/observation",
    "fantasy_simulator/reports.py",
    "fantasy_simulator/rumor_generation.py",
    ...
    "fantasy_simulator/world_location_lookup_api.py",
    ...
    "fantasy_simulator/world_persistence_hydrator.py",
    "fantasy_simulator/world_persistence_serializer.py",
    "fantasy_simulator/world_persistence_terrain.py",
