...
| K0-3 characterization / golden masters | Started | seeded characterization plus report/map golden coverage proves current behavior before broadening dynamic changes |
