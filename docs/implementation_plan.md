...
| `NarrativeContext` 拡張 | 実装済み（relation tags / reports / world memory 接続 + 細粒度 relation 分岐完了） | PR-I |
...
| PR-I | `NarrativeContext` 拡張 + 基礎世界設定の外部化土台 | ✅ 完了（細粒度 relation 分岐・SettingBundle・era 文脈・cooldown 接続） |
