...
| Map UI | マップ画面改善 | active mainline。route state、current control、world-change traces、local decision cues を atlas / region / detail へ読みやすく統合し、局所手がかりカテゴリから地点を探せる導線、地点詳細から地点履歴へ進める follow-up 導線、地点詳細の局所AA、地域図の拡大 route sketch まで追加済み |
