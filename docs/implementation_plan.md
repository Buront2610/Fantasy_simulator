...
**最終更新**: 2026-04-27 (main 反映: PR-J の初期 authoring は完了。次の mainline は PR-K)
...
13. PR-K: 動的世界変化（war / renaming / terrain mutation / era shift / civilization drift） ← **次はここ**
...
14. PR-K: 動的世界変化（war / renaming / terrain mutation / era shift / civilization drift） ← **次はここ**
...
| PR-K | 動的世界変化 | 次の mainline 対象。war / renaming / terrain mutation / era shift / civilization drift |
