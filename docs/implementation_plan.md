...
PR-0 から PR-E まで完了し、パーティ冒険 Phase 1 が実装済みである。次に着手すべき実装は **PR-F（live trace / memorial / alias）** である。
...
- loot_chance による発見物品質の差別化 (現在は常時発見、PR-F で対応)
- パーティ内の個別メンバー負傷追跡
...
6. PR-F: live trace / memorial / alias ← **次はここ**
7. PR-G: AA マップ
