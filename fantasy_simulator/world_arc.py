...
class WorldArc:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "WorldArc":
        ...
        return cls(
            ...
            last_year=int(data.get("last_year", data.get("start_year", 0))),
            last_month=int(data.get("last_month", data.get("start_month", 1))),
            last_day=int(data.get("last_day", data.get("start_day", 1))),
