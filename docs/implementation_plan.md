...
**最終更新**: 2026-04-26 (main 反映: PR-I と TD-1〜TD-4 の負債解消は完了。次の mainline は PR-J、後続は PR-K)
...
今後はこの guardrail を維持しながら、PR-J / PR-K の機能作業へ進む。
...
12. PR-J: 世界観設定整理と初期 Setting Bundle 構築 ← **次はここ**
...
次に着手すべき実装は **PR-J: 世界観設定整理と初期 Setting Bundle 構築** である。
...
mainline の UX 改善を止めない範囲で並行任意の技術検証として扱う。
PR-J で Aethoria の正式 authoring を進め、その後 PR-K で動的世界変化へ入る。
...
12. ~~TD-1〜TD-4: 負債解消~~ ✅
13. PR-J: 世界観設定整理と初期 Setting Bundle 構築 ← **次はここ**
...
**PR-J: 世界観設定整理と初期 Setting Bundle 構築** である。
...
| TD-1〜TD-4 | canonical event store / SettingBundle 外部化 / 責務分離 / guardrail 強化 | ✅ 完了。PR-J / PR-K の前提整理として閉じた |
| PR-J | 世界観設定整理と初期 Setting Bundle 構築 | 次の mainline 強化対象 |
| PR-K | 動的世界変化 | PR-J 後の mainline 対象。war / renaming / terrain mutation / era shift / civilization drift |
