...
EXPECTED_MAP_VISIBLE_BUNDLE_EN = {
    "overview": [
        ...
        "  4|SS!!$|",
        "  Sites:",
        "    (0,0) Frostpeak Summit - mountain [!] pop:1",
        "    (1,0) The Grey Pass - mountain [!]",
