...
from .map_view_models import MapRenderInfo
...
def render_world_map_ascii(world: object, highlight_location: str | None = None) -> str:
    """Build and render the stable ASCII map for a world-like object."""
    from .map_view_models import build_map_info
