...
TEXT_EN: Dict[str, str] = {
    ...
    'title_screen_signal_live': 'LIVE   day ticks -> adventurers move -> the world writes back',
    'title_screen_signal_logs': 'LOGS   combat / relations / world changes / life events',
    'title_screen_signal_atlas': 'ATLAS  roads, towns, dungeons, cultures, causes',
    'main_menu': 'MAIN MENU',
