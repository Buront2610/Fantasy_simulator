...
TEXT_EN: Dict[str, str] = {
    ...
    'title_screen_world': 'Aethoria: living histories, roads, bloodlines, and rumors',
    'title_screen_line_simulation': 'Simulate day by day, or let the world run while the log flows.',
    'title_screen_line_people': 'Follow adventurers through family, personality, battles, and choices.',
    'title_screen_line_maps': 'Read the atlas as a changing place, not only a coordinate grid.',
    'main_menu': 'MAIN MENU',
