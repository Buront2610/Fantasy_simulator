...
TEXT_EN: Dict[str, str] = {
    ...
    'cargo.departure': '{name} set out to store {quantity} units of {resource} at {destination}.',
    'cargo.no_stock': 'No owned stock with an available healthy owner can be transported.',
    'cargo.option': '{name}: {resource}, up to {quantity} units ({source})',
    'cargo.source_character': 'carried',
    'cargo.source_site': 'stored here',
    'cargo.choose_load': 'Choose cargo (blank to return): ',
    'cargo.choose_destination': 'Choose destination (blank to return): ',
    'cargo.quantity': 'Quantity (1–{maximum}): ',
    'cargo.unavailable': 'The stock or travel conditions changed; departure is unavailable.',
    'cargo.manifest': 'Cargo: {resource} ×{quantity} / {state} (ownership retained)',
    'cargo.state_planned': 'Planned',
    'cargo.state_in_transit': 'In transit',
    'cargo.state_delivered': 'Delivered',
    'cargo.state_returned': 'Returned to origin',
    'cargo.state_stranded': 'Unrecovered cargo',
    'events.adventure_cargo_delivered.summary': '{name} stored {quantity} units of {resource} at {destination}.',
    'events.adventure_cargo_missing.summary': '{name} abandoned delivery because cargo was missing.',
    'events.adventure_cargo_returned.summary': '{name} returned after completing delivery.',
    ...
    'adventure.retreat_on_trophy': 'discovery obtained',
    'adventure.retreat_never': 'no optional retreat',

    'adventure.rescue_departure': '{name} set out to rescue {target} at {location}.',
    'summary_adventure_rescued': '{name} treated {target} and took them along for the return.',
    'summary_adventure_objective_invalidated': '{name} ended the rescue plan: {reason}.',
    'summary_adventure_target_moved': '{name} updated the itinerary after {target} moved.',
    'adventure.reason_dead': 'the target has died',
    'adventure.reason_claimed': 'the target is now with another expedition',
    'adventure.reason_recovered': 'the target no longer needs rescue',
    'adventure.reason_moving': 'the target is in transit and cannot be located',
    'adventure.reason_returned': 'the target has left the previous expedition',
    'adventure.reason_supplies': 'there are insufficient supplies for treatment',
    'adventure.objective_status': ('Purpose: {purpose} / Pace: {pace} / Target: {target} / '
                                   'Retreat: {retreat} / Status: {status}'),
    'adventure.purpose_explore': 'Exploration',
    'adventure.purpose_rescue': 'Rescue',
    'adventure.pace_standard': 'Standard (expedition default)',
    'adventure.pace_cautious': 'Cautious (expedition default)',
    'adventure.pace_swift': 'Swift (expedition default)',
    'adventure.goal_active': 'Active',
    'adventure.goal_rescued': 'Rescued; returning',
    'adventure.goal_completed': 'Completed',
    'adventure.goal_failed': 'Failed',
    'adventure.goal_invalidated': 'Invalidated',
    'adventure.no_target': 'None',
    'outcome_rescued': 'Transferred to rescuers',
    'event_type_adventure_rescued': 'Rescue',
    'event_type_adventure_objective_invalidated': 'Rescue plan ended',
    'event_type_adventure_target_moved': 'Rescue itinerary updated',
    'live_trace_rescue_completed': '{name} brought the rescue target back alive from {destination} in {year}.',
    'live_trace_rescue_failed': '{name} did not complete the rescue at {destination} in {year}.',
    'events.adventure_rescued.summary': '{name} treated {target} and took them along for the return.',
    'events.adventure_objective_invalidated.summary': '{name} ended the rescue plan: {reason}.',
    'events.adventure_target_moved.summary': '{name} updated the itinerary after {target} moved.',
