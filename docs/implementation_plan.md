...
| PR-K | 動的世界変化 | active mainline。K0 guardrail slices は completed。era/civilization runtime rules と初期 faction relationship は SettingBundle から解決できる入口を追加済み。war / renaming / terrain mutation / era shift / civilization drift を K0 のガードレール上でさらに拡張する |
