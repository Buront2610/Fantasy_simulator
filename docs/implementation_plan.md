...
| K0-4 typed ID ratchet | Started | location / route / faction / event / era / culture IDs expand without breaking legacy string-load compatibility; PR-K command boundaries normalize location, route, faction, event, era, and terrain-linked IDs before domain events become records |
