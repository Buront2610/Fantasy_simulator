...
TEXT_JA: Dict[str, str] = {
    ...
    'title_screen_world': 'Aethoria: 生きた歴史、街道、血縁、噂',
    'title_screen_line_simulation': '日単位で進めるか、世界を走らせて流れるログを眺める。',
    'title_screen_line_people': '冒険者の家族、人格、戦闘、選択を追跡する。',
    'title_screen_line_maps': '地図を座標表ではなく、変化する場所として読む。',
    'main_menu': 'メインメニュー',
