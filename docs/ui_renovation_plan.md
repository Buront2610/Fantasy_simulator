...
**最終更新**: 2026-09-21（PR-K は完了。実装順は公式計画 §0 の統合設計 v1.0 に従う）
...
- [ ] generated world を既存 UI 上で開ける簡易導線を追加する（PR-G3 / PR-G4 相当、並行任意）
- [ ] terrain preview と site overlay の比較表示を試せるようにする（PR-G3 / PR-G4 相当、並行任意）
