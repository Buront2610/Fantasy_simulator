...
TEXT_JA: Dict[str, str] = {
    ...
    'local_map_legend_city': '@ 焦点、H 家、M 市場、S 祠、I 宿、G ギルド/門、C 工房、D 波止場、K 城館、W 倉、N 掲示',
    ...
    'local_map_legend_state_overlay': '! 危険、? 噂、r 荒れ',
    'local_map_scene_city_open_market': '広場を中心に地区が広がる開いた市場町',
    'local_map_scene_city_riverport': '大通り、寺院区、波止場、倉庫がある河港都市',
    'local_map_scene_city_citadel': '内郭、城館、門、外周地区を持つ城塞都市',
    'local_map_scene_village': '畑、小川、納屋、家、木立、掲示板がある開けた村',
    'local_map_scene_dungeon': '部屋と通路、祭壇、水場、瓦礫、脅威、階段がある遺跡内部',
    'local_map_scene_wild': '周囲の地形を抜ける小道が見える',
