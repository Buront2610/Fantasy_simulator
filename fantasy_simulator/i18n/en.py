...
TEXT_EN: Dict[str, str] = {
    ...
    'local_map_legend_city': '@ focus, H homes, M market, S shrine, I inn, G guild/gate, C craft, D docks, K keep',
    ...
    'local_map_legend_state_overlay': '! danger, ? rumor, r strain',
    'local_map_scene_city_open_market': 'Open market town with named districts around a civic square',
    'local_map_scene_city_riverport': 'Riverport city with a grand avenue, temple quarter, docks, and warehouses',
    'local_map_scene_city_citadel': 'Fortified city with an inner ward, keep, gates, and outer districts',
    'local_map_scene_village': 'Open village with fields, a stream, barns, homes, trees, and a notice board',
    'local_map_scene_dungeon': 'Ruin interior with rooms, corridors, altar, water, rubble, threats, and stairs',
    'local_map_scene_wild': 'Local paths cut through the surrounding terrain',
