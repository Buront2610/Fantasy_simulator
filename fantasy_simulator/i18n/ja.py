...
TEXT_JA: Dict[str, str] = {
    ...
    'cargo.departure': '{name}が{resource}を{quantity}個、{destination}へ預けるために出発した。',
    'cargo.no_stock': '運搬できる所有資源と待機中の健康な所有者がいません。',
    'cargo.option': '{name}: {resource} 最大{quantity}個（{source}）',
    'cargo.source_character': '携行中',
    'cargo.source_site': '現在地に保管',
    'cargo.choose_load': '運搬する資源を選択（空欄で戻る）: ',
    'cargo.choose_destination': '届け先を選択（空欄で戻る）: ',
    'cargo.quantity': '数量を入力（1〜{maximum}）: ',
    'cargo.unavailable': '資源または移動条件が変わったため出発できません。',
    'cargo.manifest': '荷物: {resource} ×{quantity}／{state}（所有権は維持）',
    'cargo.state_planned': '積載前',
    'cargo.state_in_transit': '輸送中',
    'cargo.state_delivered': '配達済み',
    'cargo.state_returned': '発地へ返却済み',
    'cargo.state_stranded': '未回収の荷物あり',
    'events.adventure_cargo_delivered.summary': '{name}が{destination}に{resource}を{quantity}個預けた。',
    'events.adventure_cargo_missing.summary': '{name}は荷物の不足で配達を断念した。',
    'events.adventure_cargo_returned.summary': '{name}が配達を終えて帰還した。',
    ...
    'adventure.retreat_on_trophy': '発見を得たら',
    'adventure.retreat_never': '任意撤退なし',

    'adventure.rescue_departure': ' {name} は {location} にいる {target} の救助へ出発した。',
    'summary_adventure_rescued': '{name} は {target} を処置し、帰還に同行させた。',
    'summary_adventure_objective_invalidated': '{name} の救助計画は終了した：{reason}。',
    'summary_adventure_target_moved': '{name} は {target} の移動に合わせて行程を更新した。',
    'adventure.reason_dead': '対象が死亡した',
    'adventure.reason_claimed': '対象は別の隊に同行している',
    'adventure.reason_recovered': '対象は救助が必要な状態ではなくなった',
    'adventure.reason_moving': '対象は移動中で所在を確定できない',
    'adventure.reason_returned': '対象の以前の遠征は終了した',
    'adventure.reason_supplies': '処置の物資が足りない',
    'adventure.objective_status': '目的: {purpose} / 進め方: {pace} / 対象: {target} / 撤退: {retreat} / 状態: {status}',
    'adventure.purpose_explore': '探索',
    'adventure.purpose_rescue': '救助',
    'adventure.pace_standard': '標準（冒険中の基本）',
    'adventure.pace_cautious': '慎重（冒険中の基本）',
    'adventure.pace_swift': '急行（冒険中の基本）',
    'adventure.goal_active': '進行中',
    'adventure.goal_rescued': '救助済み・帰還中',
    'adventure.goal_completed': '達成',
    'adventure.goal_failed': '未達成',
    'adventure.goal_invalidated': '失効',
    'adventure.no_target': 'なし',
    'outcome_rescued': '救助隊へ引き継ぎ',
    'event_type_adventure_rescued': '救助',
    'event_type_adventure_objective_invalidated': '救助計画終了',
    'event_type_adventure_target_moved': '救助行程更新',
    'live_trace_rescue_completed': '{name} は{year}年に {destination} の救助対象を生還させた。',
    'live_trace_rescue_failed': '{name} の{year}年の {destination} 救助計画は完了しなかった。',
    'events.adventure_rescued.summary': '{name} は {target} を処置し、帰還に同行させた。',
    'events.adventure_objective_invalidated.summary': '{name} の救助計画は終了した：{reason}。',
    'events.adventure_target_moved.summary': '{name} は {target} の移動に合わせて行程を更新した。',
    ...
    'advancing_simulation_days': 'シミュレーションを進行中...（+{days}日）',
    'simulation_advanced_to_year': 'シミュレーションを Year {year} まで進めました。',
    'simulation_advanced_to_date': 'シミュレーションを {date} まで進めました。',
    'simulation_date_label': '{year}年 {month} {day}日',
    'daily_tick_line': '{date} | +{events}イベント',
    'alive': '生存',
    'pending_choices': '保留中の選択',
    'post_results': 'シミュレーション結果',
    'what_to_view': '表示する項目を選んでください',
    'advance_1_day': '1日進める',
    'advance_daily_live': '日次ライブ進行（30日）',
    ...
    'steps': '進行段階',
    'discoveries': '発見物',
    'combat_log_header': '戦闘ログ',
    'combat_log_adventure_encounter': '戦闘遭遇: {member} vs {hazard}（{location} / step {step}）',
    'combat_log_round': (
        'R{round}: {actor} は {target} に {skill}（{action}）を使用; '
        '判定 {dice}{modifier}={attack_total} vs {defense_total}, ダメージ {damage}, {outcome}。'
    ),
    'combat_log_unknown': '不明',
    'combat_skill_basic': '通常攻撃',
    'combat_action_weapon_attack': '武器攻撃',
    'combat_action_weapon_art': '武技',
    'combat_action_spell_attack': '攻撃魔法',
    'combat_action_spell_guard': '防御魔法',
    'combat_action_maneuver': '機動',
    'combat_outcome_miss': '失敗',
    'combat_outcome_checked': '小競り合い',
    'combat_outcome_advantage': '優勢',
    'combat_outcome_decisive': '決定打',
    'combat_outcome_unknown': '結果不明',
    ...
    'save_overwrite_prompt': '既存の保存ファイルを上書きしますか？: {path}',
    'save_overwrite_confirm': '上書きする',
    'save_overwrite_cancel': 'キャンセル',
    'save_cancelled': '保存をキャンセルしました。',
    'save_failed': '保存に失敗しました: {error}',
    'save_error_io': 'I/Oまたはシリアライズエラー',
    'save_succeeded': '{path} に保存しました。',
    'unsaved_leave_prompt': '保存していないシミュレーション結果があります。メインメニューへ戻りますか？',
    'unsaved_leave_confirm': '保存せず戻る',
    'unsaved_leave_keep_reviewing': '結果画面に残る',
    ...
    'bonuses': 'ボーナス',
    'languages_header': '言語',
    'language_lineage_label': '系譜',
    'language_given_names_label': '名の例',
    'language_surnames_label': '姓の例',
    'language_lexicon_label': '語彙例',
    'language_toponym_label': '地名例',
    ...
    'family_tree_couple_line': '{partner1} + {partner2} [{status}] 子供={count} 絆={relationship}',
    'family_tree_relationship_unknown': '不明',
    'family_tree_unknown_member': '不明',
    'family_tree_member_label': '{name}（{race} {job}, 年齢{age}, {status}）',
    'combat_logs_prompt': '戦闘ログ',
    'combat_logs_latest': '最新の戦闘',
    'combat_logs_by_character': 'キャラクター別戦闘',
    'combat_logs_header': '戦闘ログ',
    'combat_logs_character_header': '{name} の戦闘ログ',
    'combat_logs_empty': '記録された戦闘ログはありません。',
    'combat_logs_truncated': '古い戦闘 {count} 件を省略しています。',
    'combat_logs_choose_detail': '詳細を見る戦闘を選んでください',
    'combat_logs_entry': '{date} | {kind} | {title} @ {location} | ラウンド={rounds}',
    'event_log_last_title': 'イベントログ - 最新',
    'event_log_full_title': 'イベントログ - 全タイムライン',
    'event_log_summary': '{shown}/{total} 件を表示 | {breakdown}',
    'event_log_summary_no_breakdown': '分類なし',
    'event_log_date_divider': '-- {date} --',
    'event_log_entry_line': '{category} {headline}',
    'event_log_meta_line': '{meta}',
    'event_log_meta_actors': '関係者: {actors}',
    'event_log_meta_location': '場所: {location}',
    'event_log_meta_severity': '重要度: {severity}',
    'event_log_category_combat': '[戦闘]',
    'event_log_category_adventure': '[冒険]',
    'event_log_category_world': '[世界]',
    'event_log_category_life': '[生死]',
    'event_log_category_relationship': '[関係]',
    'event_log_category_discovery': '[発見]',
    'event_log_category_general': '[出来事]',
    'event_log_category_count_adventure': '冒険 {count}',
    'event_log_category_count_combat': '戦闘 {count}',
    'event_log_category_count_discovery': '発見 {count}',
    'event_log_category_count_general': '出来事 {count}',
    'event_log_category_count_life': '生死 {count}',
    'event_log_category_count_relationship': '関係 {count}',
    'event_log_category_count_world': '世界 {count}',
    'live_event_stream_line': '{date} {headline} {category}',
    'live_event_stream_detail': '  {detail}',
    'live_event_stream_no_major_events': '... 大きな公的事件なし。各地の日常は続いている。',
    'live_adventure_progress': '[冒険] {name}: {summary}',
    'live_adventure_status': '[冒険] {name} は {destination} へ {state} 中（step {steps}, 物資 {supply}）',
    'family_tree_founders_header': '創始世代:',
    'family_tree_founder_line': '  {member}: {summary}',
    'founder_background_summary': (
        '{family_origin}、{family_status}。育ちは{upbringing}。'
        '冒険前は{pre_adventure}。評判は{reputation}'
    ),
    'history_founder_family_background': (
        '家族背景: {family_origin}、{family_status}。育ちは{upbringing}。'
    ),
    'history_founder_career_background': (
        '冒険前: {pre_adventure}。初期の評判は{reputation}。'
    ),
    'founder_background_family_origin_minor_noble': '小貴族の血筋',
    'founder_background_family_origin_craft_family': '職人一家',
    'founder_background_family_origin_farmstead': 'ありふれた農家',
    'founder_background_family_origin_temple_orphan': '寺院育ちの孤児の縁',
    'founder_background_family_origin_merchant_house': '商家',
    'founder_background_family_origin_soldier_line': '古い兵士の家系',
    'founder_background_family_origin_unknown_parentage': '出自不明',
    'founder_background_family_status_comfortable': 'そこそこ安定している',
    'founder_background_family_status_fallen': 'かつてより没落している',
    'founder_background_family_status_scattered': '災難で離散している',
    'founder_background_family_status_ordinary': '特に名もない普通の家',
    'founder_background_family_status_secretive': '古い秘密を抱えている',
    'founder_background_family_status_respected': '土地では尊敬されている',
    'founder_background_upbringing_strict_training': '厳しい鍛錬',
    'founder_background_upbringing_warm_household': '温かな家庭',
    'founder_background_upbringing_lonely_roads': '孤独な旅路',
    'founder_background_upbringing_apprenticed_young': '幼い頃からの徒弟生活',
    'founder_background_upbringing_self_taught': '独学',
    'founder_background_upbringing_quiet_village': '静かな村暮らし',
    'founder_background_pre_adventure_local_guard': '地元の衛兵勤め',
    'founder_background_pre_adventure_wandering_laborer': '流れの労働者',
    'founder_background_pre_adventure_failed_scholar': '学問での挫折',
    'founder_background_pre_adventure_family_debt': '家の借金',
    'founder_background_pre_adventure_pilgrim_errand': '巡礼の用向き',
    'founder_background_pre_adventure_ordinary_restlessness': 'ありふれた退屈と焦り',
    'founder_background_pre_adventure_minor_scandal': '小さな醜聞',
    'founder_background_pre_adventure_quiet_departure': '静かな出奔',
    'founder_background_reputation_promising': '有望',
    'founder_background_reputation_unremarkable': '平凡',
    'founder_background_reputation_trouble_shadow': '問題の影あり',
    'founder_background_reputation_dependable': '頼りになる',
    'founder_background_reputation_lucky': '運がいい',
    'founder_background_reputation_unproven': '未知数',
    ...
    'history_recovered_from_injuries': '{year}年: 以前の冒険で負った傷から回復した。',
    'set_out_for_adventure': '{year}年: {origin} を出発し、{destination} を目指した。',
    ...
    'detail_adventure_warfront_pressure': '{destination} は進行中の戦場に含まれており、遠征の危険度が増した。',
    'detail_adventure_blocked_route_pressure': (
        '{location} 周辺の封鎖路により、一行は危険な迂回路を進むことになった。'
    ),
    ...
    'summary_adventure_hazard_unharmed': '{name} は {destination} の危険を追加の負傷なく切り抜け、引き返した。',
    ...
    'history_adventure_detail': '{year}年: {detail}',
    ...
    'relationship_value_reconsidered': '{name1} と {name2} は {location} で古い価値観の溝を見直した。{turning_point_reason}（{name1}->{name2}: {relationship_a:+d} / {name2}->{name1}: {relationship_b:+d} / 平均: {relationship_avg:+d}）',  # noqa: E501
    ...
    'relationship_turning_point_reason_value_reconsidered': (
        '後から生まれた恩義や共通の目的が、古い食い違いを絶対ではないものにした。'
    ),
    ...
    'history_relationship_value_reconsidered': '{year}年: {location} で {name} と古い価値観の溝を見直した。',
    ...
    'population_migrant_arrived': '{name}（{race} {job}）は機会の噂に引かれ、{location} に流れ着いた。',
    'population_migrants_arrived': '{count} 人の旅人が Aethoria に流れ着き、世界の歩みをつないだ。',
    'history_migrated_to_world': '{year}年: 流れの冒険者として {location} にたどり着いた。',
    'battle_fatal': '{winner} は {loser} に勝利したが、{loser} はその戦いを生き延びられなかった。',
    'battle_normal': '{winner} は {loser} に勝利した。',
    'history_battle_win': '{year}年: {name} に {location} で勝利した。',
    'history_battle_loss': '{year}年: {name} に {location} で敗北した。',
    'history_battle_fatal': '{year}年: {name} に {location} で勝利し、相手は死亡した。',
    'discovery_narrative': '{name} は {location} 近くで {item} を発見した。{extra}',
    'history_discovery': '{year}年: {location} 近くで {item} を発見した。',
    ...
    'history_turned_age': '{year}年: {age} 歳になった。',
    'death_narrative': '{name}（{race} {job}、{age} 歳）は {cause} 亡くなった。',
    'history_passed_away': '{year}年: {cause} 亡くなった。',
    'history_lost_spouse': '{year}年: 愛する伴侶 {name} を失った。',
    ...
    'history_trained_skill': '{year}年: {skill} をレベル {new_level} まで鍛えた。',
    'journey_narrative': '{name} は {old_location} から {destination}（{region_type}）へ旅し、{road_event}。',
    'history_travelled': '{year}年: {old_location} から {destination} へ旅した。',
    ...
    'roster_detail_prompt': '詳細を見るキャラクター番号を入力してください（ENTERで戻る）: ',
    'roster_profile_header': '{name} の詳細',
    'roster_profile_identity': '{race} の {job}、{age}歳、{status}、負傷 {injury}、現在地 {location}',
    'roster_profile_stats': (
        '能力 STR {strength} / INT {intelligence} / DEX {dexterity} / '
        'WIS {wisdom} / CHA {charisma} / CON {constitution}'
    ),
    'roster_profile_personality': '性格: {summary}',
    'roster_profile_temperament': '基礎気質: {archetype}',
    'roster_profile_feats': '特徴: {feats}',
    'roster_profile_current_personality': '現在の気質: {archetype}; {summary}（影響: {factors}）',
    'roster_profile_background': '経歴',
    'roster_profile_family': '家族',
    'roster_profile_relationships': '関係',
    'roster_profile_relationship_memory': '関係記憶',
    'roster_profile_relationship_history': '関係史',
    'roster_profile_recent_history': '最近の履歴',
    'roster_profile_recent_combat': '最近の戦闘',
    'roster_profile_no_background': '初代背景は記録されていません。',
    'roster_profile_no_family': '近しい家族関係は記録されていません。',
    'roster_profile_no_relationships': '名前付きの関係は記録されていません。',
    'roster_profile_no_relationship_memory': '由来付きの関係記憶は記録されていません。',
    'roster_profile_no_relationship_history': '関係イベントは記録されていません。',
    'roster_profile_no_history': '個人履歴は記録されていません。',
    'roster_profile_spouse': '配偶者: {name}',
    'roster_profile_parents': '親: {names}',
    'roster_profile_children': '子: {names}',
    'roster_profile_relation': '{name}: {score:+d}{tags}',
    'roster_profile_relationship_memory_line': '{name} [{tag}]: {description}',
    'roster_profile_relationship_memory_unavailable': '元イベントは利用できません',
    'roster_profile_relationship_event': '{date} | {kind} | {description}',
    'roster_profile_relationship_cause': '原因: {causes}',
    'roster_profile_relationship_cause_unavailable': '原因: 元イベントは利用できません。',
    'roster_profile_relationship_factor': '要因: {factors}',
    'roster_profile_combat_line': '{date} | {kind} | {title} @ {location} | ラウンド={rounds}',
    ...
    'customize_personality': '性格を手動設定しますか？ (y/N)',
    ...
    'event_log_empty': '記録されたイベントはありません。',
    'event_log_caused_by': '原因: {events}',
    'event_log_causes_unavailable': '原因: 元イベントは利用できません。',
    'event_log_combat_summary': '戦闘ログ: {rounds} ラウンド。詳細は戦闘ログ画面で確認できます。',
    'event_log_relationship_reason': '関係要因: {reasons}',
    'event_log_personality_reason': '人格 {factors}、相性 {affinity:+d}、変化 {delta:+d}',
    'event_log_catalyst_reason': 'きっかけ {factors}、補正 {bonus:+d}',
    'event_log_no_personality_factors': '未記録の気質要因',
    'event_log_no_catalyst_factors': '未記録の共有体験',
    ...
    'personality_trait_name_openness': '開放性',
    'personality_trait_name_discipline': '規律性',
    'personality_trait_name_extraversion': '社交性',
    'personality_trait_name_agreeableness': '協調性',
    'personality_trait_name_stability': '安定性',
    'personality_trait_openness': '開放性 {value}（{level}）',
    'personality_trait_discipline': '規律性 {value}（{level}）',
    'personality_trait_extraversion': '社交性 {value}（{level}）',
    'personality_trait_agreeableness': '協調性 {value}（{level}）',
    'personality_trait_stability': '安定性 {value}（{level}）',
    'personality_level_high': '高',
    'personality_level_mid': '中',
    'personality_level_low': '低',
    'personality_archetype_steady_mediator': '落ち着いた仲裁者',
    'personality_archetype_steadfast_guardian': '堅実な守り手',
    'personality_archetype_restless_seeker': '落ち着かない探求者',
    'personality_archetype_quiet_scholar': '静かな探究者',
    'personality_archetype_pragmatic_traditionalist': '実務的な保守派',
    'personality_archetype_volatile_maverick': '不安定な一匹狼',
    'personality_archetype_reserved_planner': '控えめな計画家',
    'personality_archetype_gentle_neighbor': '穏やかな隣人',
    'personality_archetype_curious_wanderer': '好奇心ある放浪者',
    'personality_archetype_balanced_adventurer': '均衡した冒険者',
    'personality_feat_brave': '勇敢',
    'personality_feat_patient_listener': '忍耐強い聞き手',
    'personality_feat_quick_tempered': '短気',
    'personality_feat_oathbound': '誓約重視',
    'personality_feat_curious_mind': '好奇心旺盛',
    'personality_feat_scarred_survivor': '傷を越えた生存者',
    'personality_feat_silver_tongue': '弁舌巧み',
    'personality_feat_lone_wolf': '単独志向',
    'personality_feat_family_minded': '家族思い',
    'personality_feat_reckless': '無鉄砲',
    'personality_feat_affinity_shared_features': '似た特徴を持つ',
    'personality_feat_affinity_temper_balanced': '一方の気質がもう一方を受け止めた',
    'personality_feat_affinity_hard_won_courage': '苦難で得た勇気',
    'personality_feat_affinity_vow_vs_impulse': '誓いと衝動がぶつかる',
    'personality_feat_affinity_home_vs_distance': '家庭への志向と距離感が噛み合わない',
    'personality_feat_affinity_social_bridge': '社交性が隔たりを埋めた',
    'personality_affinity_shared_kindness': '互いに温和',
    'personality_affinity_low_trust': '信頼しづらい',
    'personality_affinity_steady_pair': '気質が安定',
    'personality_affinity_volatile_pair': '気質が不安定',
    'personality_affinity_shared_curiosity': '好奇心が近い',
    'personality_affinity_shared_discipline': '規律を重んじる',
    'personality_affinity_social_mismatch': '社交のリズムが違う',
    'personality_affinity_outlook_gap': 'ものの見方が違う',
    'personality_affinity_balanced': '均衡した気質',
    'personality_context_rescued_gratitude': '救われた後の感謝',
    'personality_context_rescuer_responsibility': '誰かを救った責任感',
    'personality_context_recent_fear': '直近の恐怖',
    'personality_context_grief': '喪失の痛み',
    'personality_context_combat_tension': '戦闘の緊張',
    'personality_context_recent_wonder': '直近の驚き',
    'personality_context_relief': '回復後の安堵',
    'relationship_catalyst_rescue_debt': '救助の恩',
    'relationship_catalyst_family_bond': '家族としての責任',
    'relationship_catalyst_shared_adventure': '共にした冒険',
    'relationship_catalyst_prior_romance': '以前の恋のきざし',
    'relationship_catalyst_hard_won_respect': 'ぶつかり合って得た敬意',
    'relationship_catalyst_shared_values': '共有した価値観',
    'relation_tag_friend': '友人',
    'relation_tag_rival': '宿敵',
    'relation_tag_spouse': '配偶者',
    'relation_tag_parent': '親',
    'relation_tag_child': '子',
    'relation_tag_co_parent': '共同親',
    ...
    'relation_tag_shared_values': '共有価値',
    'relation_tag_value_rift': '価値観の溝',
    ...
    'event_type_adventure_combat': '冒険中の戦闘',
    'event_type_death': '死亡',
    'event_type_anniversary': '記念日',
    'event_type_romance': '恋愛',
    'event_type_relationship_reconciliation': '和解',
    'event_type_relationship_conflict': '関係衝突',
    ...
    'event_type_relationship_value_reconsidered': '価値観の再考',
    ...
    'event_type_adventure_encounter': '冒険中の遭遇',
    ...
    'events.birth.summary': '{parent1} と {parent2} の子 {child} が {location} で生まれた。',
    ...
    'events.relationship_value_reconsidered.summary': (
        '{name1} と {name2} は {location} で古い価値観の溝を見直した。{turning_point_reason}'
        '（{name1}->{name2}: {relationship_a:+d} / {name2}->{name1}: {relationship_b:+d} / '
        '平均: {relationship_avg:+d}）'
    ),
    ...
    'events.war_battle.summary': (
        '{attacker_faction} と {defender_faction} が {location} 付近で会戦した。'
    ),
    ...
    'rumor_board_title': '噂一覧',
    'rumor_board_empty': '現在流通している噂はありません。',
    'rumor_board_meta': '発生地: {location} | 経過: {age}ヶ月 | 拡散: {spread}/10 | 元イベント: {event}',
    'rumor_board_prompt': "噂番号、'l'で発生地絞り込み、'c'で解除、ENTERで戻る: ",
    'rumor_board_filter_prompt': '発生地ID/名前（ENTERでキャンセル）: ',
    'rumor_board_filter_label': '絞り込み: {location}',
    'rumor_board_filter_cleared': '噂の発生地絞り込みを解除しました。',
    ...
    'rumor_board_event_missing': '元イベントは利用できません。',
    'rumor_board_event_unavailable': '利用できないイベント',
    'rumor_board_related_location': '関連地点',
    'rumor_board_related_records': '関連記録',
    ...
    'detail_adventure_hazard_combat': (
        '{name} は {destination} で {hazard} と交戦し、{rounds} ラウンドの末に傷を負った。'
    ),
    # UI ラベル
    ...
    'location_recent_events_label': '最近の出来事',
    'no_live_traces': '最近の訪問記録なし。',
    'no_memorials': 'この地点に記念碑はない。',
    'no_recent_events': '最近の出来事は記録されていない。',
    'location_live_traces_truncated': '... 他 {count} 件の古い訪問記録',
    'location_recent_events_truncated': '... 他 {count} 件の古い出来事',
    'memorial_entry': '【{year}年】{epitaph}',
    'location_recent_event_entry': '【{year}年】{description}',
    ...
    'dashboard_title': '{world} ダッシュボード',
    'dashboard_active_adventures': '進行中の冒険: {count}',
    'dashboard_pending_choices': '保留中の選択: {count}',
    'dashboard_major_events': '重要事件',
    ...
    'auto_pause_recommendation_inspect_character': '{actor} の状態を確認',
    ...
    'map_region_focus_profile': '地誌: {location} - {profile}',
    ...
    'local_map_legend_city': '@ 焦点、H 家、M 市場、S 祠、I 宿、G 門/ギルド、C 工房、D 波止場、K 城館',
    'local_map_legend_settlement': '@ 中心、h 家、M 市場、S 祠、b 納屋、w 水車、" 畑、~ 水辺',
    ...
    'local_map_legend_local_cues': '局所手がかり記号はスケッチ手がかり欄に表示',
    ...
    'local_map_scene_city_citadel': 'プロファイル: 城塞 / 城館 / 門',
    'local_map_scene_village': 'プロファイル: 畑 / 家 / 小道',
    'local_map_scene_village_field': 'プロファイル: 畑村 / 納屋 / 小道',
    'local_map_scene_village_riverside': 'プロファイル: 川村 / 橋 / 水車',
    'local_map_scene_village_woodland': 'プロファイル: 森村 / 祠 / 小径',
    'local_map_scene_village_highland': 'プロファイル: 山村 / 岩場 / 坂道',
    'local_map_scene_dungeon': 'プロファイル: 遺跡 / 部屋 / 階段',
    'local_map_scene_dungeon_flooded': 'プロファイル: 水没遺跡 / 水場 / 瓦礫',
    'local_map_scene_dungeon_cavern': 'プロファイル: 洞窟遺跡 / 荒い部屋 / 脅威',
    'local_map_scene_dungeon_vault': 'プロファイル: 埋没庫 / 祭壇 / 宝',
    'local_map_scene_wild': 'プロファイル: 野道 / 地形遮蔽',
    'local_map_scene_occupied_city': 'プロファイル: 占領都市 / 検問 / 兵舎',
    'local_map_scene_mourning_city': 'プロファイル: 喪の都市 / 記念広場 / 静かな道',
    'local_map_scene_mourning_village': 'プロファイル: 喪の村 / 記念路 / 閉ざされた家',
    'map_profile_generic_short': '普通の場所',
    'map_profile_generic_summary': '{location} はまだ支配的な地誌プロファイルを持たない普通の場所。',
    'map_profile_occupied_city_short': '占領下の城塞都市',
    'map_profile_occupied_city_summary': '{location} は占領下の城塞都市で、検問と兵舎が往来を形作っている。',
    'map_profile_mourning_city_short': '喪に沈む都市',
    'map_profile_mourning_city_summary': '{location} は喪に沈む都市で、記念広場と静かな通りが情景を決めている。',
    'map_profile_riverport_city_short': '河港都市',
    'map_profile_riverport_city_summary': '{location} は河港都市で、岸壁、倉庫、湿った道を中心に広がる。',
    'map_profile_market_city_short': '交易都市',
    'map_profile_market_city_summary': '{location} は交易都市で、街道が市場とギルド街へ集まっている。',
    'map_profile_walled_city_short': '城壁都市',
    'map_profile_walled_city_summary': '{location} は城壁都市で、門、中央道、市民施設で構成されている。',
    'map_profile_mourning_village_short': '喪に沈む村',
    'map_profile_mourning_village_summary': '{location} は喪に沈む村で、記念碑と閉ざされた家々が目につく。',
    'map_profile_riverside_village_short': '川沿い村',
    'map_profile_riverside_village_summary': '{location} は川沿い村で、水辺に沿って橋、水車、畑が並ぶ。',
    'map_profile_woodland_village_short': '森村',
    'map_profile_woodland_village_summary': '{location} は森村で、木立と祠への小径に包まれている。',
    'map_profile_highland_hamlet_short': '山村',
    'map_profile_highland_hamlet_summary': '{location} は山村で、岩場、坂道、見張り場に形作られている。',
    'map_profile_field_village_short': '畑村',
    'map_profile_field_village_summary': '{location} は畑村で、納屋、小道、耕作地が暮らしを支えている。',
    'map_profile_flooded_dungeon_short': '水没ダンジョン',
    'map_profile_flooded_dungeon_summary': '{location} は水没ダンジョンで、水場と瓦礫が遺跡を遮っている。',
    'map_profile_danger_dungeon_short': '危険なダンジョン',
    'map_profile_danger_dungeon_summary': '{location} は危険なダンジョンで、深部の部屋の周囲に脅威の気配が濃い。',
    'map_profile_cavern_dungeon_short': '洞窟ダンジョン',
    'map_profile_cavern_dungeon_summary': '{location} は洞窟ダンジョンで、荒い部屋と岩の落差に刻まれている。',
    'map_profile_buried_vault_short': '埋没庫',
    'map_profile_buried_vault_summary': '{location} は埋没庫で、古い部屋、祭壇、隠された宝が中心にある。',
    'map_profile_forest_paths_short': '森の小径',
    'map_profile_forest_paths_summary': '{location} は森の小径で、濃い木陰の下を道が抜けている。',
    'map_profile_mountain_pass_short': '山道',
    'map_profile_mountain_pass_summary': '{location} は山道で、岩場、見張り場、狭い経路が目立つ。',
    'map_profile_open_wilds_short': '開けた野地',
    'map_profile_open_wilds_summary': '{location} は開けた野地で、集落よりも藪と踏み跡が目立つ。',
    ...
    'map_legend_site_city': '都市プロファイル',
    'map_legend_site_village': '村プロファイル',
    'map_legend_site_dungeon': 'ダンジョンプロファイル',
    ...
    'map_feature_tower': '塔/城砦',
    'map_feature_bridge': '橋',
    'map_feature_shrine': '祠',
    'map_feature_inn': '宿',
    'map_feature_guild': 'ギルド',
    'map_feature_mill': '水車/風車',
    'map_feature_dock': '波止場',
    'map_feature_forge': '鍛冶場',
    'map_feature_warehouse': '倉庫',
    'map_feature_stable': '厩舎',
    'map_feature_barracks': '兵舎',
    'map_feature_graveyard': '墓地',
    'map_feature_library': '書庫',
    'map_feature_ruined_house': '廃屋',
    'map_feature_workshop': '工房',
    'map_feature_farmstead': '農家',
    'map_feature_watch_camp': '見張り野営地',
    'map_feature_arena': '闘技場',
