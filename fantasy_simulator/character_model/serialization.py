...
def serialize_character(character: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        **abilities_payload,
        ...
        "personality_feats": list(character.personality_feats),
        "known_languages": dict(getattr(character, "known_languages", {})),
        "relationships": dict(character.relationships),
        "relationship_details": relationship_payload,
        "alive": character.alive,
        "location_id": character.location_id,
        "residence_location_id": character.residence_location_id,
        **narrative_payload,
...
def deserialize_character(
    ...
    *,
    ...
    return character_cls(
        ...
        personality_feats=data.get("personality_feats"),
        known_languages=data.get("known_languages"),
        relationships=relationships,
        alive=data.get("alive", True),
        location_id=location_id,
        residence_location_id=data.get("residence_location_id"),
