"""
Event system for the Fantasy Simulator.
...
from .relationships import resolve_marriage_event, resolve_meeting_event
from .selection import EVENT_WEIGHTS, find_collocated_pair, find_romance_pair, generate_random_event
