...
if TYPE_CHECKING:
    ...
    from ..world_topology.route_graph import RouteCollection
...
class WorldEraMixin:
    ...
    def apply_era_shift(
        ...
        *,
        ...
        from .pressure import apply_era_pressure_to_locations
    ...
    def apply_civilization_phase_drift(
        ...
        *,
        ...
        from .pressure import apply_civilization_pressure_to_locations
