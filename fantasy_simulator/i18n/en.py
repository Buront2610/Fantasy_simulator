...
TEXT_EN: Dict[str, str] = {
    ...
    'title_screen_signal_live': 'Days pass; adventurers choose; the world leaves traces.',
    'title_screen_signal_logs': 'Blades, bonds, edicts, births, and deaths enter the chronicle.',
    'title_screen_signal_atlas': 'Roads, towns, ruins, cultures, and causal lines are surveyed.',
    'main_menu': 'MAIN MENU',
